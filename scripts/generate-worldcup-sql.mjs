...
const migrationPath = path.resolve(
  "supabase/migrations/20260601193000_worldcup_game.sql",
);

const teams = [
  ["france", "France", "UEFA", "I", "9/2", 1.0],
  ["spain", "Spain", "UEFA", "H", "9/2", 1.0],
  ...
  ["curacao", "Curaçao", "Concacaf", "E", "1000/1", 3.0],
  ["jordan", "Jordan", "AFC", "J", "1000/1", 3.0],
  ["haiti", "Haiti", "Concacaf", "C", "1000/1", 3.0],
  ["uzbekistan", "Uzbekistan", "AFC", "K", "1000/1", 3.0],
  ["cabo_verde", "Cabo Verde", "CAF", "H", "1000/1", 3.0],
  ["iraq", "Iraq", "AFC", "I", "1000/1", 3.0],
  ["panama", "Panama", "Concacaf", "L", "1000/1", 3.0],
];

const stages = [
  ["group_stage", "Group Stage", 1, 1.0],
...
const matches = [
  [1, "group_stage", "A", "2026-06-11", "13:00", "Estadio Azteca", "Mexico City", "mexico", "south_africa"],
  [2, "group_stage", "A", "2026-06-11", "20:00", "Estadio Akron", "Guadalajara", "korea_republic", "czechia"],
  [3, "group_stage", "B", "2026-06-12", "15:00", "BMO Field", "Toronto", "canada", "bosnia_herzegovina"],
  [4, "group_stage", "D", "2026-06-12", "18:00", "SoFi Stadium", "Los Angeles", "united_states", "paraguay"],
  [5, "group_stage", "C", "2026-06-13", "21:00", "Gillette Stadium", "Boston", "haiti", "scotland"],
  [6, "group_stage", "D", "2026-06-13", "21:00", "BC Place", "Vancouver", "australia", "turkiye"],
  [7, "group_stage", "C", "2026-06-13", "18:00", "MetLife Stadium", "New York / New Jersey", "brazil", "morocco"],
  [8, "group_stage", "B", "2026-06-13", "12:00", "Levi's Stadium", "San Francisco Bay Area", "qatar", "switzerland"],
  [9, "group_stage", "E", "2026-06-14", "19:00", "Lincoln Financial Field", "Philadelphia", "cote_divoire", "ecuador"],
  [10, "group_stage", "E", "2026-06-14", "12:00", "NRG Stadium", "Houston", "germany", "curacao"],
  [11, "group_stage", "F", "2026-06-14", "15:00", "AT&T Stadium", "Dallas", "netherlands", "japan"],
  [12, "group_stage", "F", "2026-06-14", "20:00", "Estadio BBVA", "Monterrey", "sweden", "tunisia"],
  [13, "group_stage", "H", "2026-06-15", "18:00", "Hard Rock Stadium", "Miami", "saudi_arabia", "uruguay"],
  [14, "group_stage", "H", "2026-06-15", "12:00", "Mercedes-Benz Stadium", "Atlanta", "spain", "cabo_verde"],
  [15, "group_stage", "G", "2026-06-15", "18:00", "SoFi Stadium", "Los Angeles", "ir_iran", "new_zealand"],
  [16, "group_stage", "G", "2026-06-15", "12:00", "Lumen Field", "Seattle", "belgium", "egypt"],
  [17, "group_stage", "I", "2026-06-16", "15:00", "MetLife Stadium", "New York / New Jersey", "france", "senegal"],
  [18, "group_stage", "I", "2026-06-16", "18:00", "Gillette Stadium", "Boston", "iraq", "norway"],
  [19, "group_stage", "J", "2026-06-16", "20:00", "Arrowhead Stadium", "Kansas City", "argentina", "algeria"],
  [20, "group_stage", "J", "2026-06-16", "21:00", "Levi's Stadium", "San Francisco Bay Area", "austria", "jordan"],
  [21, "group_stage", "L", "2026-06-17", "19:00", "BMO Field", "Toronto", "ghana", "panama"],
  [22, "group_stage", "L", "2026-06-17", "15:00", "AT&T Stadium", "Dallas", "england", "croatia"],
  [23, "group_stage", "K", "2026-06-17", "12:00", "NRG Stadium", "Houston", "portugal", "congo_dr"],
  [24, "group_stage", "K", "2026-06-17", "20:00", "Estadio Azteca", "Mexico City", "uzbekistan", "colombia"],
  [25, "group_stage", "A", "2026-06-18", "12:00", "Mercedes-Benz Stadium", "Atlanta", "czechia", "south_africa"],
  [26, "group_stage", "B", "2026-06-18", "12:00", "SoFi Stadium", "Los Angeles", "switzerland", "bosnia_herzegovina"],
  [27, "group_stage", "B", "2026-06-18", "15:00", "BC Place", "Vancouver", "canada", "qatar"],
  [28, "group_stage", "A", "2026-06-18", "19:00", "Estadio Akron", "Guadalajara", "mexico", "korea_republic"],
  [29, "group_stage", "C", "2026-06-19", "21:00", "Lincoln Financial Field", "Philadelphia", "brazil", "haiti"],
  [30, "group_stage", "C", "2026-06-19", "18:00", "Gillette Stadium", "Boston", "scotland", "morocco"],
  [31, "group_stage", "D", "2026-06-19", "20:00", "Levi's Stadium", "San Francisco Bay Area", "turkiye", "paraguay"],
  [32, "group_stage", "D", "2026-06-19", "12:00", "Lumen Field", "Seattle", "united_states", "australia"],
  [33, "group_stage", "E", "2026-06-20", "16:00", "BMO Field", "Toronto", "germany", "cote_divoire"],
  [34, "group_stage", "E", "2026-06-20", "19:00", "Arrowhead Stadium", "Kansas City", "ecuador", "curacao"],
  [35, "group_stage", "F", "2026-06-20", "12:00", "NRG Stadium", "Houston", "netherlands", "sweden"],
  [36, "group_stage", "F", "2026-06-20", "22:00", "Estadio BBVA", "Monterrey", "tunisia", "japan"],
  [37, "group_stage", "H", "2026-06-21", "18:00", "Hard Rock Stadium", "Miami", "uruguay", "cabo_verde"],
  [38, "group_stage", "H", "2026-06-21", "12:00", "Mercedes-Benz Stadium", "Atlanta", "spain", "saudi_arabia"],
  [39, "group_stage", "G", "2026-06-21", "12:00", "SoFi Stadium", "Los Angeles", "belgium", "ir_iran"],
  [40, "group_stage", "G", "2026-06-21", "18:00", "BC Place", "Vancouver", "new_zealand", "egypt"],
  [41, "group_stage", "I", "2026-06-22", "20:00", "MetLife Stadium", "New York / New Jersey", "norway", "senegal"],
  [42, "group_stage", "I", "2026-06-22", "17:00", "Lincoln Financial Field", "Philadelphia", "france", "iraq"],
  [43, "group_stage", "J", "2026-06-22", "12:00", "AT&T Stadium", "Dallas", "argentina", "austria"],
  [44, "group_stage", "J", "2026-06-22", "20:00", "Levi's Stadium", "San Francisco Bay Area", "jordan", "algeria"],
  [45, "group_stage", "L", "2026-06-23", "16:00", "Gillette Stadium", "Boston", "england", "ghana"],
  [46, "group_stage", "L", "2026-06-23", "19:00", "BMO Field", "Toronto", "panama", "croatia"],
  [47, "group_stage", "K", "2026-06-23", "12:00", "NRG Stadium", "Houston", "portugal", "uzbekistan"],
  [48, "group_stage", "K", "2026-06-23", "20:00", "Estadio Akron", "Guadalajara", "colombia", "congo_dr"],
  [49, "group_stage", "C", "2026-06-24", "18:00", "Hard Rock Stadium", "Miami", "scotland", "brazil"],
  [50, "group_stage", "C", "2026-06-24", "18:00", "Mercedes-Benz Stadium", "Atlanta", "morocco", "haiti"],
  [51, "group_stage", "B", "2026-06-24", "12:00", "BC Place", "Vancouver", "switzerland", "canada"],
  [52, "group_stage", "B", "2026-06-24", "12:00", "Lumen Field", "Seattle", "bosnia_herzegovina", "qatar"],
  [53, "group_stage", "A", "2026-06-24", "19:00", "Estadio Azteca", "Mexico City", "czechia", "mexico"],
  [54, "group_stage", "A", "2026-06-24", "19:00", "Estadio BBVA", "Monterrey", "south_africa", "korea_republic"],
  [55, "group_stage", "E", "2026-06-25", "16:00", "Lincoln Financial Field", "Philadelphia", "curacao", "cote_divoire"],
  [56, "group_stage", "E", "2026-06-25", "16:00", "MetLife Stadium", "New York / New Jersey", "ecuador", "germany"],
  [57, "group_stage", "F", "2026-06-25", "18:00", "AT&T Stadium", "Dallas", "japan", "sweden"],
  [58, "group_stage", "F", "2026-06-25", "18:00", "Arrowhead Stadium", "Kansas City", "tunisia", "netherlands"],
  [59, "group_stage", "D", "2026-06-25", "19:00", "SoFi Stadium", "Los Angeles", "turkiye", "united_states"],
  [60, "group_stage", "D", "2026-06-25", "19:00", "Levi's Stadium", "San Francisco Bay Area", "paraguay", "australia"],
  [61, "group_stage", "I", "2026-06-26", "15:00", "Gillette Stadium", "Boston", "norway", "france"],
  [62, "group_stage", "I", "2026-06-26", "15:00", "BMO Field", "Toronto", "senegal", "iraq"],
  [63, "group_stage", "G", "2026-06-26", "20:00", "Lumen Field", "Seattle", "egypt", "ir_iran"],
  [64, "group_stage", "G", "2026-06-26", "20:00", "BC Place", "Vancouver", "new_zealand", "belgium"],
  [65, "group_stage", "H", "2026-06-26", "19:00", "NRG Stadium", "Houston", "cabo_verde", "saudi_arabia"],
  [66, "group_stage", "H", "2026-06-26", "18:00", "Estadio Akron", "Guadalajara", "uruguay", "spain"],
  [67, "group_stage", "L", "2026-06-27", "17:00", "MetLife Stadium", "New York / New Jersey", "panama", "england"],
  [68, "group_stage", "L", "2026-06-27", "17:00", "Lincoln Financial Field", "Philadelphia", "croatia", "ghana"],
  [69, "group_stage", "J", "2026-06-27", "21:00", "Arrowhead Stadium", "Kansas City", "algeria", "austria"],
  [70, "group_stage", "J", "2026-06-27", "21:00", "AT&T Stadium", "Dallas", "jordan", "argentina"],
  [71, "group_stage", "K", "2026-06-27", "19:30", "Hard Rock Stadium", "Miami", "colombia", "portugal"],
  [72, "group_stage", "K", "2026-06-27", "19:30", "Mercedes-Benz Stadium", "Atlanta", "congo_dr", "uzbekistan"],
...
const matchValues = values(
  matches.map((row) => [...row, ...Array(11 - row.length).fill(null)]),
);

const sql = `-- WorldCup team-picking fantasy game.
