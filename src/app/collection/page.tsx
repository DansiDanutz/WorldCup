...
const CARDS: Card[] = [
  ...
  { number: '022', name: 'The Lamassu',           nation: 'Iraq',         episode: 22, match: 'Iraq vs Norway',        portrait: '/special-cards/legend-022-portrait.png', landscape: '/special-cards/legend-022-landscape.png' },
  { number: '023', name: 'The Petra Guardian',    nation: 'Jordan',       episode: 23, match: 'Austria vs Jordan',     portrait: '/special-cards/legend-023-portrait.png', landscape: '/special-cards/legend-023-landscape.png' },
  ...
  { number: '025', name: 'The Checkered Knight',  nation: 'Croatia',      episode: 25, match: 'England vs Croatia',    portrait: '/special-cards/legend-025-portrait.png', landscape: '/special-cards/legend-025-landscape.png' },
  { number: '026', name: 'The Canal Pilot',       nation: 'Panama',       episode: 26, match: 'Ghana vs Panama',       portrait: '/special-cards/legend-026-portrait.png', landscape: '/special-cards/legend-026-landscape.png' },
  { number: '027', name: 'The Silk Road Trader',  nation: 'Uzbekistan',   episode: 27, match: 'Uzbekistan vs Colombia',portrait: '/special-cards/legend-027-portrait.png', landscape: '/special-cards/legend-027-landscape.png' },
  { number: '028', name: 'The Vuvuzela Maestro',  nation: 'South Africa', episode: 28, match: 'Czech Republic vs South Africa', portrait: '/special-cards/legend-028-portrait.png', landscape: '/special-cards/legend-028-landscape.png' },
  { number: '029', name: 'The Alpine Guide',      nation: 'Switzerland',  episode: 29, match: 'Switzerland vs Bosnia', portrait: '/special-cards/legend-029-portrait.png', landscape: '/special-cards/legend-029-landscape.png' },
  { number: '030', name: 'The Pearl Diver',       nation: 'Qatar',        episode: 30, match: 'Canada vs Qatar',       portrait: '/special-cards/legend-030-portrait.png', landscape: '/special-cards/legend-030-landscape.png' },
  { number: '031', name: 'The Luchador',          nation: 'Mexico',       episode: 31, match: 'Mexico vs South Korea',  portrait: '/special-cards/legend-031-portrait.png', landscape: '/special-cards/legend-031-landscape.png' },
  { number: '032', name: 'The Songline Keeper',   nation: 'Australia',    episode: 32, match: 'USA vs Australia',     portrait: '/special-cards/legend-032-portrait.png', landscape: '/special-cards/legend-032-landscape.png' },
  { number: '033', name: 'The Highland Chieftain',nation: 'Scotland',     episode: 33, match: 'Scotland vs Morocco',   portrait: '/special-cards/legend-033-portrait.png', landscape: '/special-cards/legend-033-landscape.png' },
  { number: '034', name: 'The Whirling Dervish',  nation: 'Turkey',       episode: 34, match: 'Turkey vs Paraguay',    portrait: '/special-cards/legend-034-portrait.png', landscape: '/special-cards/legend-034-landscape.png' },
  { number: '035', name: 'The Viking Seafarer',   nation: 'Sweden',       episode: 35, match: 'Netherlands vs Sweden', portrait: '/special-cards/legend-035-portrait.png', landscape: '/special-cards/legend-035-landscape.png' },
  { number: '036', name: 'The Black Forest Huntsman',nation: 'Germany',   episode: 36, match: 'Germany vs Ivory Coast',portrait: '/special-cards/legend-036-portrait.png', landscape: '/special-cards/legend-036-landscape.png' },
  ...
  { number: '045', name: 'The Sock-Ball',         nation: 'Senegal',      episode: 45, match: 'Norway vs Senegal',     portrait: '/special-cards/legend-045-portrait.png', landscape: '/special-cards/legend-045-landscape.png' },
  ...
  { number: '051', name: 'The Bridge Keeper',     nation: 'Bosnia & Herzegovina', episode: 51, match: 'Bosnia & Herzegovina vs Qatar', portrait: '/special-cards/legend-051-portrait.png', landscape: '/special-cards/legend-051-landscape.png' },
  { number: '052', name: 'The Watchmaker',        nation: 'Switzerland',  episode: 52, match: 'Switzerland vs Canada', portrait: '/special-cards/legend-052-portrait.png', landscape: '/special-cards/legend-052-landscape.png' },
  { number: '053', name: 'The Capoeira Master',   nation: 'Brazil',       episode: 53, match: 'Scotland vs Brazil', portrait: '/special-cards/legend-053-portrait.png', landscape: '/special-cards/legend-053-landscape.png' },
  ...
  { number: '058', name: 'The Weaver',            nation: 'Ecuador',      episode: 58, match: 'Ecuador vs Germany', portrait: '/special-cards/legend-058-portrait.png', landscape: '/special-cards/legend-058-landscape.png' },
  { number: '059', name: 'The Origami Master',     nation: 'Japan',        episode: 59, match: 'Japan vs Sweden', portrait: '/special-cards/legend-059-portrait.png', landscape: '/special-cards/legend-059-landscape.png' },
