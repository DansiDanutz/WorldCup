...
const CARDS: Card[] = [
  { number: '008', name: 'The Elder',             nation: 'Ghana',        episode: 8,  match: 'England vs Ghana',       portrait: '/special-cards/legend-008-portrait.png', landscape: '/special-cards/legend-008-landscape.png' },
  ...
  { number: '013', name: 'The Blue Samurai Elder',nation: 'Japan',        episode: 13, match: 'Netherlands vs Japan',   portrait: '/special-cards/legend-013-portrait.png', landscape: '/special-cards/legend-013-landscape.png' },
