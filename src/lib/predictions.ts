...
export const PREDICTIONS: MatchPrediction[] = [
  ...
  },
  {
    ...
    date: "Jun 17, 2026",
    score: "2–1",
    hook: "The tiny kingdom at its first-ever World Cup; Baumgartner strikes, Al-Naimat levels, Alaba heads the winner.",
    youtube: null,
  },
  {
    ep: 24,
    ...
    date: "Jun 17, 2026",
    score: "3–1",
    hook: "The Leopards opened a continent's door in 1974; Ronaldo's last chase, the free kick the world got wrong.",
    youtube: null,
  },
  {
    ep: 25,
    ...
    date: "Jun 17, 2026",
    score: "2–1",
    hook: "The 4-million nation that broke England in 2018; Kane heads in, Kramarić levels, Bellingham settles the ghost late.",
    youtube: null,
  },
];
