...
- Referral link fallback: https://worldcup26.world/login?ref=26BC4B90CB&utm_source=posting-cockpit&utm_medium=operator-copy&utm_campaign=worldcup26_referral_72h&utm_content=fallback

This is the operator start page. It opens the right handoff pages and keeps the proof rule visible.

## Open First

- [Proof SLA](proof-sla.html) - Freshness, oldest actions, proof commands
- [Proof Audit](proof-audit.html) - Truth report for latest real external proof and invalid proof rows
- [Proof URL Recovery](proof-url-recovery.html) - Recover public permalinks for private X proof notes
- [Proof Rescue](proof-rescue.html) - One-screen phone checklist for the oldest real-world proof gaps
- [Social Rescue](social-rescue-pack.html) - One-tap social/share buttons for the oldest proof gaps
- [One-Click Share](one-click-share.html) - Fastest owned-account share actions with copy and proof buttons
- [Public Outreach Targets](public-outreach-targets.html) - Search/social/community targets across all four workers
- [Login Unlock Board](login-unlock-board.html) - Login and verification blockers that must be cleared before public posting
- [Proof Intake](proof-intake.html) - Fast proof logging after a real action exists
- [Top Six Mobile](top-six-mobile.html) - Fastest phone-first six actions
- [Phone Action Center](phone-action-center.html) - Full urgent queue with copy buttons
- [Share Command Center](share-command-center.html) - All tracked share links
- [Paid Traffic Guard](paid-traffic-guard.html) - Ad landing click safety
- [Paid Dashboard Checks](paid-dashboard-checks.html) - Structured Meta and X delivery numbers
- [Paid Ad Triage](paid-ad-triage.html) - Meta and X dashboard proof plus zero-click decision rules
- [Paid No-Click Rescue](paid-no-click-rescue.html) - Compliant free-first creative variants for zero-click ads
- [Ad Ops Links](ad-ops-links.html) - Meta and X Ads Manager links plus dashboard check commands
- [Escalation Board](escalation-board.html) - Stale-worker pressure board
