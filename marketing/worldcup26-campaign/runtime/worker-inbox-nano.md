...
- Facebook: https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fworldcup26.world%2Flogin%3Fref%3D26BC4B90CB%26utm_source%3Dwhatsapp-personal%26utm_medium%3Dmanual-outreach%26utm_campaign%3Dworldcup26_referral_72h%26utm_content%3Dnano_h2
...
- 6. DM follow-up / Reply to first reactions and send the simple how-it-works answer
  - Asset: `campaign/copy-bank.md`
  ...
  - Private proof template: `node campaign-proof-log.mjs --priority "6" --proof-url "private-reply-note: replied to <thread/contact initials> at YYYY-MM-DD HH:mm EEST; code 26BC4B90CB and link included; next follow-up <date/action>" --status "replied"`

- 9. Replies / Answer questions using reply bank; push code/link once per conversation
  - Asset: `campaign/copy-bank.md`
  ...
  - Private proof template: `node campaign-proof-log.mjs --priority "9" --proof-url "private-reply-note: replied to <thread/contact initials> at YYYY-MM-DD HH:mm EEST; code 26BC4B90CB and link included; next follow-up <date/action>" --status "replied"`

- 11. WhatsApp personal / Send second warm-contact batch with main invite
  - Asset: `media/worldcup26-main-video.mp4`
  ...
  - Private proof template: `node campaign-proof-log.mjs --priority "11" --proof-url "private-whatsapp: sent to <N> warm contacts from <phone/account> at YYYY-MM-DD HH:mm EEST; asset media/worldcup26-main-video.mp4; code 26BC4B90CB and link included; replies <N>" --status "sent"`

- 15. Direct DMs / Send one-to-one invite to people who reacted to stories
  - Asset: `campaign/copy-bank.md`
  ...
  - Private proof template: `node campaign-proof-log.mjs --priority "15" --proof-url "manual-post-note: posted from <account/destination> at YYYY-MM-DD HH:mm EEST; asset campaign/copy-bank.md; code 26BC4B90CB and link included; replace with public URL when available" --status "sent"`
