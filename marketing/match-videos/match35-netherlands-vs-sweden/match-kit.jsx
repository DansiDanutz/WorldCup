...
const MV = {
  ...
  gold: '#ffd24a',
  goldDeep: '#c9942e',
  // Netherlands: orange (team A = aut/autSoft slots)
  aut: '#F36C21',
  autSoft: '#ff9a5a',
  // Sweden: blue + yellow (team B = jor/jorGreen slots)
  jor: '#006AA7',
  jorGreen: '#FECC00',
  jorRed: '#FECC00',
  green: '#006AA7',
...
function ScoreBug({ start, aut = 0, jor = 0, minute }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ ...cell, background: MV.aut, color: '#fff' }}>NED</div>
      <div style={{ ...cell, fontSize: 38, color: MV.gold }}>{aut} — {jor}</div>
      <div style={{ ...cell, background: MV.jor, color: '#fff' }}>SWE</div>
