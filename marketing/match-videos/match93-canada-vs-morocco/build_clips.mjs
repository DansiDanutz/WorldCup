// Ep93 Canada vs Morocco (Play-Offs) — PHOTOREAL + NO-REPEAT + NO-LOOP + nation-correct (#28)
...
const clips = [
  ...
  C('can-thunderbird', 'can-thunderbird.mp4', 5.0, 5.0),
  ...
  C('can-wave', 'can-wave.mp4', 54.0, 1.5),
  C('can-davies', 'can-davies.mp4', 55.5, 5.0),
  C('can-david', 'can-david.mp4', 60.5, 3.24),
  C('can-larin', 'can-larin.mp4', 63.74, 4.26),
  C('can-eustaquio', 'can-eustaquio.mp4', 68.0, 2.99),
  C('can-buchanan', 'can-buchanan.mp4', 70.99, 5.0),
  ...
  C('ma-hakimi', 'ma-hakimi.mp4', 90.6, 5.0),
  C('ma-ziyech', 'ma-ziyech.mp4', 96.8, 3.15),
  C('ma-ennesyri', 'ma-ennesyri.mp4', 99.95, 3.05),
  C('ma-amrabat', 'ma-amrabat.mp4', 103.0, 2.71),
  C('ma-brahim', 'ma-brahim.mp4', 105.71, 5.0),
  // RIDDLE 113-132
  ...
  C('can-attack', 'can-attack.mp4', 137.0, 5.0),
  C('bono-save', 'bono-save.mp4', 142.0, 10.21),
  C('david-goal', 'david-goal.mp4', 152.21, 5.0),
  ...
  C('ma-surge', 'ma-surge.mp4', 172.0, 5.0),
...
const out = {
  comment: 'Ep93 Canada vs Morocco PHOTOREAL, nation-correct (#28) + likeness (#29), NO-REPEAT+NO-LOOP, showcase SYNCED. OUR PREDICTION Morocco 2-1 Canada (Canada score first, Morocco comeback; En-Nesyri late winner). Legend 093 Atlas Lion. Canada reused Ep77, Morocco reused Ep80 (Rule #26); Atlas Lion card + handshake fresh; atmo backdrops reused. vol=0.',
  clips,
  music: { cues: [
...
const LOOP_EXEMPT = (id) => id.startsWith('bg-') || id === 'bono-save';
let loop = [];
