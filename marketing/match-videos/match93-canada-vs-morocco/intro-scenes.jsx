// intro-scenes.jsx — Ep93 · 15s MYSTIC INTRO (rule #20). Wordless, atmospheric face-off: Atlas Lion
// and the Black Star, the two flags rising from shadow, an igniting "VS", the WorldCup26 Legends
// wordmark, then a whoosh-fade into the cold open. Reuses FlagCAN/FlagMA from match-scenes.jsx.
...
function SceneIntro() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      {sideUnit(<FlagCAN w={300} />, 'CANADA', leftX, '#d52b1e')}
      {sideUnit(<FlagMA w={300} />, 'MOROCCO', rightX, '#0a8a43')}
      ...
      <div style={{ position: 'absolute', bottom: 120, left: 0, right: 0, textAlign: 'center', zIndex: 20, opacity: themeP * (1 - fadeOut) }}>
        <div style={{ display: 'inline-block', fontFamily: '"Inter",sans-serif', fontWeight: 800, fontSize: 30, letterSpacing: '0.13em', color: '#ffe9a0', textShadow: '0 2px 18px rgba(0,0,0,0.85)' }}>THE THUNDERBIRD AND THE ATLAS LION</div>
      </div>
