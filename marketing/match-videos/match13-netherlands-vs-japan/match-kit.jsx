...
function FlagNED({ w = 120 }) {
  ...
  return (
    <div style={{ width: w, height: h, borderRadius: w * 0.04, position: 'relative', overflow: 'hidden', boxShadow: '0 6px 18px rgba(0,0,0,0.45)' }}>
      <div style={{ position: 'absolute', left: 0, right: 0, top: 0, height: '33.33%', background: '#ae1c28' }} />
      <div style={{ position: 'absolute', left: 0, right: 0, top: '33.33%', height: '33.33%', background: '#ffffff' }} />
      <div style={{ position: 'absolute', left: 0, right: 0, bottom: 0, height: '33.33%', background: '#21468b' }} />
    </div>
  );
}
...
function FlagJPN({ w = 120 }) {
  const h = w * 0.66;
  return (
    <div style={{ width: w, height: h, borderRadius: w * 0.04, position: 'relative', overflow: 'hidden', background: '#ffffff', boxShadow: '0 6px 18px rgba(0,0,0,0.45)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ width: h * 0.62, height: h * 0.62, borderRadius: '50%', background: '#bc002d' }} />
    </div>
  );
}
