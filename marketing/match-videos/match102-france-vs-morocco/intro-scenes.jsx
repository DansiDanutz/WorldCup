// intro-scenes.jsx — Ep102 · 15s MYSTIC INTRO (rule #20). Wordless, atmospheric face-off: the
// Paladin's nation and the Atlas Lions, the two flags rising from shadow, an igniting
// "VS", the WorldCup26 Legends wordmark, then a whoosh-fade into the cold open. Reuses
// FlagFRA/FlagMOR from match-scenes.jsx.
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      <div style={{ position: 'absolute', top: 96, left: 0, right: 0, textAlign: 'center', zIndex: 20, opacity: titleP * (1 - fadeOut) }}>
        <Kicker size={30} color="#e8c97a">WorldCup26 Legends · Episode 102</Kicker>
      </div>
      {sideUnit(<FlagFRA w={230} />, 'FRANCE', leftX, '#0055A4')}
      {sideUnit(<FlagMOR w={230} />, 'MOROCCO', rightX, '#006233')}
      ...
      <div style={{ position: 'absolute', bottom: 120, left: 0, right: 0, textAlign: 'center', zIndex: 20, opacity: themeP * (1 - fadeOut) }}>
        <div style={{ display: 'inline-block', fontFamily: '"Inter",sans-serif', fontWeight: 800, fontSize: 30, letterSpacing: '0.13em', color: '#ffe9a0', textShadow: '0 2px 18px rgba(0,0,0,0.85)' }}>THE HORN THAT NEVER YIELDS</div>
      </div>
