// intro-scenes.jsx — Ep89 · 15s MYSTIC INTRO (rule #20). Wordless, atmospheric
// face-off: the mountain and the fox, the two flags rising from shadow, an igniting "VS", the
// WorldCup26 Legends wordmark, then a whoosh-fade into the cold open.
// Reuses FlagCH/FlagDZ from match-scenes.jsx. Concatenated to the FRONT of the body → ~333s.
...
function SceneIntro() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      {sideUnit(<FlagCH w={300} />, 'SWITZERLAND', leftX, '#da291c')}
      {sideUnit(<FlagDZ w={300} />, 'ALGERIA', rightX, '#006233')}
      ...
      <div style={{ position: 'absolute', bottom: 120, left: 0, right: 0, textAlign: 'center', zIndex: 20, opacity: themeP * (1 - fadeOut) }}>
        <div style={{ display: 'inline-block', fontFamily: '"Inter",sans-serif', fontWeight: 800, fontSize: 30, letterSpacing: '0.34em', color: '#ffe9a0', textShadow: '0 2px 18px rgba(0,0,0,0.85)' }}>THE MOUNTAIN AND THE FOX</div>
      </div>
