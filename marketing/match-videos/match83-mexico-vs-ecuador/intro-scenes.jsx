// intro-scenes.jsx — Ep83 · 15s MYSTIC INTRO (rule #20). Wordless, atmospheric
// face-off: the serpent and the condor, the two flags rising from shadow, an igniting "VS", the
// WorldCup26 Legends wordmark, then a whoosh-fade into the cold open.
// Reuses FlagMX/FlagEC from match-scenes.jsx. Concatenated to the FRONT of the body → ~333s.
...
function SceneIntro() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      {sideUnit(<FlagEC w={300} />, 'ECUADOR', rightX, '#ffd100')}
      ...
      <div style={{ position: 'absolute', bottom: 120, left: 0, right: 0, textAlign: 'center', zIndex: 20, opacity: themeP * (1 - fadeOut) }}>
        <div style={{ display: 'inline-block', fontFamily: '"Inter",sans-serif', fontWeight: 800, fontSize: 30, letterSpacing: '0.34em', color: '#ffe9a0', textShadow: '0 2px 18px rgba(0,0,0,0.85)' }}>THE SERPENT AND THE CONDOR</div>
      </div>
