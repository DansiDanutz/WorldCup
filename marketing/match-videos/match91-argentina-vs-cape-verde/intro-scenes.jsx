// intro-scenes.jsx — Ep91 · 15s MYSTIC INTRO (rule #20). Wordless, atmospheric face-off: the sun
// and the shark, the two flags rising from shadow, an igniting "VS", the WorldCup26 Legends
// wordmark, then a whoosh-fade into the cold open. Reuses FlagAR/FlagCV from match-scenes.jsx.
...
function SceneIntro() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      {sideUnit(<FlagAR w={300} />, 'ARGENTINA', leftX, '#75aadb')}
      {sideUnit(<FlagCV w={300} />, 'CAPE VERDE', rightX, '#0a3aa0')}
      ...
      <div style={{ position: 'absolute', bottom: 120, left: 0, right: 0, textAlign: 'center', zIndex: 20, opacity: themeP * (1 - fadeOut) }}>
        <div style={{ display: 'inline-block', fontFamily: '"Inter",sans-serif', fontWeight: 800, fontSize: 30, letterSpacing: '0.34em', color: '#ffe9a0', textShadow: '0 2px 18px rgba(0,0,0,0.85)' }}>THE SUN AND THE SHARK</div>
      </div>
