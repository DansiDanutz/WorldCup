...
function FlagSCO({ w = 120 }) {
  const h = w * 0.6;
  const bar = { position: 'absolute', left: '50%', top: '-20%', width: w * 0.14, height: '140%', background: '#fff', transformOrigin: 'center' };
  return (
    <div style={{ width: w, height: h, borderRadius: w * 0.04, position: 'relative', overflow: 'hidden', background: '#005eb8', boxShadow: '0 6px 18px rgba(0,0,0,0.45)' }}>
      <div style={{ ...bar, transform: 'translateX(-50%) rotate(58deg)' }} />
      <div style={{ ...bar, transform: 'translateX(-50%) rotate(-58deg)' }} />
    </div>
  );
}
...
function FlagTUR({ w = 120 }) {
  const h = w * 0.66;
  return (
    <div style={{ width: w, height: h, borderRadius: w * 0.04, position: 'relative', overflow: 'hidden', background: '#e30a17', boxShadow: '0 6px 18px rgba(0,0,0,0.45)', display: 'flex', alignItems: 'center' }}>
      <div style={{ position: 'absolute', left: '34%', top: '50%', transform: 'translate(-50%,-50%)', width: h * 0.42, height: h * 0.42, borderRadius: '50%', background: '#fff' }} />
      <div style={{ position: 'absolute', left: '40%', top: '50%', transform: 'translate(-50%,-50%)', width: h * 0.34, height: h * 0.34, borderRadius: '50%', background: '#e30a17' }} />
      <div style={{ position: 'absolute', left: '52%', top: '50%', transform: 'translate(-50%,-50%)', color: '#fff', fontSize: h * 0.26 }}>★</div>
    </div>
  );
}
...
function FlagGER({ w = 120 }) {
  ...
  return (
    <div style={{ width: w, height: h, borderRadius: w * 0.04, position: 'relative', overflow: 'hidden', boxShadow: '0 6px 18px rgba(0,0,0,0.45)' }}>
      <div style={{ position: 'absolute', left: 0, right: 0, top: 0, height: '33.33%', background: '#000' }} />
      <div style={{ position: 'absolute', left: 0, right: 0, top: '33.33%', height: '33.33%', background: '#dd0000' }} />
      <div style={{ position: 'absolute', left: 0, right: 0, bottom: 0, height: '33.33%', background: '#ffce00' }} />
    </div>
  );
}
...
function FlagCUR({ w = 120 }) {
  const h = w * 0.66;
  return (
    <div style={{ width: w, height: h, borderRadius: w * 0.04, position: 'relative', overflow: 'hidden', background: '#002b7f', boxShadow: '0 6px 18px rgba(0,0,0,0.45)' }}>
      <div style={{ position: 'absolute', left: 0, right: 0, bottom: h * 0.16, height: h * 0.16, background: '#f9d90f' }} />
      <div style={{ position: 'absolute', left: w * 0.12, top: h * 0.18, color: '#fff', fontSize: h * 0.26, lineHeight: 1 }}>★</div>
      <div style={{ position: 'absolute', left: w * 0.04, top: h * 0.42, color: '#fff', fontSize: h * 0.18, lineHeight: 1 }}>★</div>
    </div>
  );
}
