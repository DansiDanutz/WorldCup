...
const MASTER = process.argv[2] || 'WorldCup26_Match12_GER_CUR_upload.mp4';

const SHORTS = [
  { out: 'short1_david.mp4', from: 0.0, to: 16.0, head: 'DAVID<br>vs GOLIATH' },
  { out: 'short2_the_save.mp4', from: 186.0, to: 207.5, head: 'MINUTE 34.<br>THE SAVE.' },
  { out: 'short3_legend.mp4', from: 252.5, to: 272.0, head: 'LEGEND 012:<br>BEACH KEEPER' },
];
