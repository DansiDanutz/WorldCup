// intro-scenes.jsx — Ep99 · 15s MYSTIC INTRO (rule #20). Wordless, atmospheric face-off: the
// Genius and the Pharaoh, the two flags rising from shadow, an igniting "VS", the WorldCup26
// Legends wordmark, then a whoosh-fade into the cold open. Reuses FlagARG/FlagEGY from
// match-scenes.jsx.
...
function SceneIntro() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      {sideUnit(<FlagARG w={300} />, 'ARGENTINA', leftX, '#74acdf')}
      {sideUnit(<FlagEGY w={300} />, 'EGYPT', rightX, '#ce1126')}
      ...
      <div style={{ position: 'absolute', bottom: 120, left: 0, right: 0, textAlign: 'center', zIndex: 20, opacity: themeP * (1 - fadeOut) }}>
        <div style={{ display: 'inline-block', fontFamily: '"Inter",sans-serif', fontWeight: 800, fontSize: 30, letterSpacing: '0.13em', color: '#ffe9a0', textShadow: '0 2px 18px rgba(0,0,0,0.85)' }}>THE GENIUS AND THE PHARAOH</div>
      </div>
