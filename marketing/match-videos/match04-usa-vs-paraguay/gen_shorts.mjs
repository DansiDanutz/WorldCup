...
const MASTER = process.argv[2] || 'WorldCup26_Match04_USA_PAR_upload.mp4';

const SHORTS = [
  { out: 'short1_1930_secret.mp4', from: 0.0, to: 16.0,
    head: '1930.<br>THE SECRET.' },
  { out: 'short2_cliffhanger.mp4', from: 207.0, to: 236.0,
    head: 'YOU DECIDE<br>THE ENDING' },
  { out: 'short3_liberty_fan.mp4', from: 254.0, to: 274.0,
    head: 'THE LIBERTY<br>FAN' },
];
