// intro-scenes.jsx — Ep95 · 15s MYSTIC INTRO (rule #20). Wordless, atmospheric face-off: Fenrir
// and the Black Star, the two flags rising from shadow, an igniting "VS", the WorldCup26 Legends
// wordmark, then a whoosh-fade into the cold open. Reuses FlagNO/FlagBRA from match-scenes.jsx.
...
function SceneIntro() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      {sideUnit(<FlagNO w={300} />, 'NORWAY', leftX, '#c8102e')}
      {sideUnit(<FlagBRA w={300} />, 'BRAZIL', rightX, '#009b3a')}
      ...
      <div style={{ position: 'absolute', bottom: 120, left: 0, right: 0, textAlign: 'center', zIndex: 20, opacity: themeP * (1 - fadeOut) }}>
        <div style={{ display: 'inline-block', fontFamily: '"Inter",sans-serif', fontWeight: 800, fontSize: 30, letterSpacing: '0.13em', color: '#ffe9a0', textShadow: '0 2px 18px rgba(0,0,0,0.85)' }}>THE WOLF AND THE SPIRIT OF SAMBA</div>
      </div>
