// intro-scenes.jsx — Ep84 · 15s MYSTIC INTRO (rule #20). Wordless, atmospheric
// face-off: the lions and the leopard, the two flags rising from shadow, an igniting "VS", the
// WorldCup26 Legends wordmark, then a whoosh-fade into the cold open.
// Reuses FlagENG/FlagCD from match-scenes.jsx. Concatenated to the FRONT of the body → ~333s.
...
function SceneIntro() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      {sideUnit(<FlagENG w={300} />, 'ENGLAND', leftX, '#27348b')}
      {sideUnit(<FlagCD w={300} />, 'DR CONGO', rightX, '#cf0921')}
      ...
      <div style={{ position: 'absolute', bottom: 120, left: 0, right: 0, textAlign: 'center', zIndex: 20, opacity: themeP * (1 - fadeOut) }}>
        <div style={{ display: 'inline-block', fontFamily: '"Inter",sans-serif', fontWeight: 800, fontSize: 30, letterSpacing: '0.34em', color: '#ffe9a0', textShadow: '0 2px 18px rgba(0,0,0,0.85)' }}>THE LIONS AND THE LEOPARD</div>
      </div>
