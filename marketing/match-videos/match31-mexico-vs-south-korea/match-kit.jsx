...
function FlagMEX({ w = 120 }) {
  ...
  return (
    <div style={{ width: w, height: h, borderRadius: w * 0.05, position: 'relative', overflow: 'hidden', display: 'flex', boxShadow: '0 6px 18px rgba(0,0,0,0.45)' }}>
      ...
      <div style={{ flex: 1, background: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><span style={{ fontSize: h * 0.4, lineHeight: 1 }}>🦅</span></div>
...
function ScoreBug({ start, aut = 0, jor = 0, minute }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ ...cell, background: MV.aut, color: '#fff' }}>MEX</div>
      <div style={{ ...cell, fontSize: 38, color: MV.gold }}>{aut} — {jor}</div>
      <div style={{ ...cell, background: MV.jor, color: '#fff' }}>KOR</div>
