...
const MASTER = process.argv[2] || 'WorldCup26_Match02_KOR_CZE.mp4';

const SHORTS = [
  { out: 'short1_last_dance.mp4', from: 0.0, to: 16.0,
    head: 'HIS LAST<br>DANCE.' },
  { out: 'short2_minute_41.mp4', from: 195.0, to: 226.0,
    head: 'MINUTE 41.<br>SON.' },
  { out: 'short3_taekwondo_master.mp4', from: 254.0, to: 274.0,
    head: 'THE TAEKWONDO<br>MASTER' },
];
