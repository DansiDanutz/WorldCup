...
const clips = [
  ...
  C('be-lukaku', 'be-lukaku.mp4', 61.1, 4.6),
  C('be-doku', 'be-doku.mp4', 65.7, 2.3),
  C('be-tielemans', 'be-tielemans.mp4', 68.0, 3.8),
  C('be-onana', 'be-onana.mp4', 71.8, 5.0),
  ...
  C('sn-mane', 'sn-mane.mp4', 90.6, 3.0),
  C('sn-jackson', 'sn-jackson.mp4', 93.6, 3.0),
  C('sn-koulibaly', 'sn-koulibaly.mp4', 96.6, 5.0),
  C('sn-papesarr', 'sn-papesarr.mp4', 103.0, 3.6),
  C('sn-ismailasarr', 'sn-ismailasarr.mp4', 106.6, 5.0),
  // RIDDLE 113-132
