// intro-scenes.jsx — Ep76 · 15s MYSTIC INTRO (rule #20). Wordless, atmospheric
...
// Reuses FlagGER/FlagPAR from match-scenes.jsx. Concatenated to the FRONT of the body → ~333s.
...
function SceneIntro() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      {sideUnit(<FlagGER w={300} />, 'GERMANY', leftX, '#d8a01e')}
      {sideUnit(<FlagPAR w={300} />, 'PARAGUAY', rightX, '#cf1326')}
      ...
      <div style={{ position: 'absolute', bottom: 120, left: 0, right: 0, textAlign: 'center', zIndex: 20, opacity: themeP * (1 - fadeOut) }}>
        <div style={{ display: 'inline-block', fontFamily: '"Inter",sans-serif', fontWeight: 800, fontSize: 30, letterSpacing: '0.34em', color: '#ffe9a0', textShadow: '0 2px 18px rgba(0,0,0,0.85)' }}>THE MACHINE vs THE NIGHT</div>
      </div>
