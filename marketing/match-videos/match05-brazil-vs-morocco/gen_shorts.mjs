...
const MASTER = process.argv[2] || 'WorldCup26_Match05_BRA_MAR_upload.mp4';

const SHORTS = [
  { out: 'short1_sixth_vision.mp4', from: 0.0, to: 16.0,
    head: 'THE 6TH<br>VISION' },
  { out: 'short2_neymar_sees.mp4', from: 210.0, to: 237.0,
    head: 'HE SEES WHAT<br>NOBODY SEES' },
  { out: 'short3_prophet.mp4', from: 254.0, to: 274.0,
    head: 'THE FEATHERED<br>PROPHET' },
];
