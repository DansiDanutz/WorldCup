// intro-scenes.jsx — Ep86 · 15s MYSTIC INTRO (rule #20). Wordless, atmospheric
...
// Reuses FlagUS/FlagBA from match-scenes.jsx. Concatenated to the FRONT of the body → ~333s.
...
function SceneIntro() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      {sideUnit(<FlagUS w={300} />, 'USA', leftX, '#0a2240')}
      {sideUnit(<FlagBA w={300} />, 'BOSNIA', rightX, '#1f4ea1')}
      ...
      <div style={{ position: 'absolute', bottom: 120, left: 0, right: 0, textAlign: 'center', zIndex: 20, opacity: themeP * (1 - fadeOut) }}>
        <div style={{ display: 'inline-block', fontFamily: '"Inter",sans-serif', fontWeight: 800, fontSize: 30, letterSpacing: '0.34em', color: '#ffe9a0', textShadow: '0 2px 18px rgba(0,0,0,0.85)' }}>THE EAGLE AND THE DRAGON</div>
      </div>
