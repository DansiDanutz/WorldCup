// intro-scenes.jsx — Ep93 · 15s MYSTIC INTRO (rule #20). Wordless, atmospheric face-off: Susanoo
// and the Black Star, the two flags rising from shadow, an igniting "VS", the WorldCup26 Legends
// wordmark, then a whoosh-fade into the cold open. Reuses FlagJPN/FlagRSA from match-scenes.jsx.
...
function SceneIntro() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      {sideUnit(<FlagJPN w={300} />, 'JAPAN', leftX, '#bc002d')}
      {sideUnit(<FlagRSA w={300} />, 'SOUTH AFRICA', rightX, '#f4c20d')}
      ...
      <div style={{ position: 'absolute', bottom: 120, left: 0, right: 0, textAlign: 'center', zIndex: 20, opacity: themeP * (1 - fadeOut) }}>
        <div style={{ display: 'inline-block', fontFamily: '"Inter",sans-serif', fontWeight: 800, fontSize: 30, letterSpacing: '0.14em', color: '#ffe9a0', textShadow: '0 2px 18px rgba(0,0,0,0.85)' }}>THE STORM GOD AND THE LIGHTNING BIRD</div>
      </div>
