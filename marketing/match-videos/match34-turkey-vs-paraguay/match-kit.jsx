...
const MV = {
  ...
  gold: '#ffd24a',
  goldDeep: '#c9942e',
  // Turkey: red + white crescent (team A = aut/autSoft slots)
  aut: '#E30A17',
  autSoft: '#ff5a63',
  // Paraguay: blue + red (team B = jor/jorGreen slots)
  jor: '#0038A8',
  jorGreen: '#D52B1E',
  jorRed: '#D52B1E',
  green: '#0038A8',
...
// Turkey: red field with a white crescent and star toward the hoist.
function FlagTUR({ w = 120 }) {
  const h = w * 2 / 3;
  return (
    <div style={{ width: w, height: h, borderRadius: w * 0.04, position: 'relative', overflow: 'hidden', background: '#E30A17', boxShadow: '0 6px 18px rgba(0,0,0,0.45)' }}>
      <div style={{ position: 'absolute', left: w * 0.30, top: '50%', transform: 'translateY(-50%)', width: h * 0.42, height: h * 0.42, borderRadius: '50%', background: '#fff' }} />
      <div style={{ position: 'absolute', left: w * 0.37, top: '50%', transform: 'translateY(-50%)', width: h * 0.34, height: h * 0.34, borderRadius: '50%', background: '#E30A17' }} />
      <div style={{ position: 'absolute', left: w * 0.50, top: '50%', transform: 'translateY(-50%)', color: '#fff', fontSize: h * 0.26, lineHeight: 1 }}>★</div>
    </div>
  );
}
// Paraguay: three horizontal bands red / white / blue.
function FlagPAR({ w = 120 }) {
  const h = w * 0.6;
  return (
    <div style={{ width: w, height: h, borderRadius: w * 0.04, position: 'relative', overflow: 'hidden', boxShadow: '0 6px 18px rgba(0,0,0,0.45)' }}>
      <div style={{ position: 'absolute', left: 0, right: 0, top: 0, height: '33.34%', background: '#D52B1E' }} />
      <div style={{ position: 'absolute', left: 0, right: 0, top: '33.33%', height: '33.34%', background: '#fff' }} />
      <div style={{ position: 'absolute', left: 0, right: 0, top: '66.66%', height: '33.34%', background: '#0038A8' }} />
    </div>
  );
}
