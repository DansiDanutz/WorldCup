// intro-scenes.jsx — Ep97 · 15s MYSTIC INTRO (rule #20). Wordless, atmospheric face-off: the
// Hidden King and the Raging Bull, the two flags rising from shadow, an igniting "VS", the
// WorldCup26 Legends wordmark, then a whoosh-fade into the cold open. Reuses FlagPOR/FlagESP from
// match-scenes.jsx.
...
function SceneIntro() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      {sideUnit(<FlagPOR w={300} />, 'PORTUGAL', leftX, '#8b1538')}
      {sideUnit(<FlagESP w={300} />, 'SPAIN', rightX, '#c60b1e')}
      ...
      <div style={{ position: 'absolute', bottom: 120, left: 0, right: 0, textAlign: 'center', zIndex: 20, opacity: themeP * (1 - fadeOut) }}>
        <div style={{ display: 'inline-block', fontFamily: '"Inter",sans-serif', fontWeight: 800, fontSize: 30, letterSpacing: '0.13em', color: '#ffe9a0', textShadow: '0 2px 18px rgba(0,0,0,0.85)' }}>THE HIDDEN KING AND THE RAGING BULL</div>
      </div>
