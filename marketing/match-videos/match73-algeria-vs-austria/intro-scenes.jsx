// intro-scenes.jsx — Ep73 · 15s MYSTIC INTRO (rule #20). Wordless, atmospheric
...
// Reuses FlagALG/FlagAUT from match-scenes.jsx. Concatenated to the FRONT of the body → ~333s.
...
function SceneIntro() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      {sideUnit(<FlagALG w={300} />, 'ALGERIA', leftX, '#0f7a3a')}
      {sideUnit(<FlagAUT w={300} />, 'AUSTRIA', rightX, '#e4002b')}
      ...
      <div style={{ position: 'absolute', bottom: 120, left: 0, right: 0, textAlign: 'center', zIndex: 20, opacity: themeP * (1 - fadeOut) }}>
        <div style={{ display: 'inline-block', fontFamily: '"Inter",sans-serif', fontWeight: 800, fontSize: 30, letterSpacing: '0.34em', color: '#ffe9a0', textShadow: '0 2px 18px rgba(0,0,0,0.85)' }}>DESERT vs ALPS · THE RECKONING</div>
      </div>
