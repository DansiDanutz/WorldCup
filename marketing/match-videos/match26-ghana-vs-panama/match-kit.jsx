...
const MV = {
  ...
  gold: '#ffd24a',
  goldDeep: '#c9942e',
  // Ghana — the Black Stars: red / gold / green
  aut: '#ce1126',
  autSoft: '#fcd116',
  // Panama — Los Canaleros: red / blue / white
  jor: '#da121a',
  jorGreen: '#072357',
  jorRed: '#da121a',
  green: '#072357',
...
function FlagPAN({ w = 120 }) {
  const h = w * 2 / 3;
  return (
    <div style={{ width: w, height: h, borderRadius: w * 0.05, position: 'relative', overflow: 'hidden', display: 'grid', gridTemplateColumns: '1fr 1fr', gridTemplateRows: '1fr 1fr', boxShadow: '0 6px 18px rgba(0,0,0,0.45)' }}>
      <div style={{ background: '#fff', position: 'relative' }}><div style={{ position: 'absolute', left: '50%', top: '50%', transform: 'translate(-50%,-50%)', color: '#072357', fontSize: h * 0.3, lineHeight: 1 }}>★</div></div>
      <div style={{ background: '#da121a' }} />
      <div style={{ background: '#072357' }} />
      <div style={{ background: '#fff', position: 'relative' }}><div style={{ position: 'absolute', left: '50%', top: '50%', transform: 'translate(-50%,-50%)', color: '#da121a', fontSize: h * 0.3, lineHeight: 1 }}>★</div></div>
    </div>
  );
}
