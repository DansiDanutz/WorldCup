// intro-scenes.jsx — Ep96 · 15s MYSTIC INTRO (rule #20). Wordless, atmospheric face-off: the
// Feathered Serpent and the Three Lions, the two flags rising from shadow, an igniting "VS", the
// WorldCup26 Legends wordmark, then a whoosh-fade into the cold open. Reuses FlagMX/FlagENG from
// match-scenes.jsx.
...
function SceneIntro() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      {sideUnit(<FlagMX w={300} />, 'MEXICO', leftX, '#1f7a4d')}
      {sideUnit(<FlagENG w={300} />, 'ENGLAND', rightX, '#ce1124')}
      ...
      <div style={{ position: 'absolute', bottom: 120, left: 0, right: 0, textAlign: 'center', zIndex: 20, opacity: themeP * (1 - fadeOut) }}>
        <div style={{ display: 'inline-block', fontFamily: '"Inter",sans-serif', fontWeight: 800, fontSize: 30, letterSpacing: '0.13em', color: '#ffe9a0', textShadow: '0 2px 18px rgba(0,0,0,0.85)' }}>THE FEATHERED SERPENT AND THE THREE LIONS</div>
      </div>
