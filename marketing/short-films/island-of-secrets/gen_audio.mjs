...
// More emotional, expressive storyteller delivery (lower stability = more emotive,
// higher style = more dramatic warmth) — we want the viewer to FEEL it.
const voice_settings = { stability: 0.33, similarity_boost: 0.88, style: 0.60, use_speaker_boost: true };
