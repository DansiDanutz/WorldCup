# Mystery Supporter Prompt — Switzerland

## Character Concept
The Alpine Watchmaker — a master horologist who builds a special pocket watch for each World Cup, claiming the chimes predict Swiss match outcomes

## Visual Description

Create a Pixar-style 3D character portrait of a mystical, legendary Switzerland supporter:
...
- Skin/face: May have weathered texture, tribal markings, or symbolic paint in team colors (red, white)

**Outfit & Accessories:**
- Traditional or culturally significant clothing mixed with team colors
- Swiss flag / Edelweiss motif subtly integrated into design
...
- Rich colors with red, white accent lighting
