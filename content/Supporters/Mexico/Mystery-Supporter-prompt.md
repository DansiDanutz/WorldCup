# Mystery Supporter Prompt — Mexico

## Character Concept
The Aztec Warrior — a fan who dresses in full Aztec jaguar warrior regalia and performs a pre-match ritual at the Templo Mayor replica, channeling Huitzilopochtli

## Visual Description

Create a Pixar-style 3D character portrait of a mystical, legendary Mexico supporter:
...
- Skin/face: May have weathered texture, tribal markings, or symbolic paint in team colors (green, white, red)

**Outfit & Accessories:**
- Traditional or culturally significant clothing mixed with team colors
- Eagle and Snake motif subtly integrated into design
...
- Rich colors with green, white, red accent lighting
