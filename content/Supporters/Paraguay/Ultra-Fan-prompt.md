# Ultra Fan Prompt — Paraguay

## Character Concept
A die-hard Paraguay football ultra — the most passionate, loud, and dedicated supporter in the stadium. They bleed the team colors (red, white, blue) and live for match day.

## Visual Description

Create a Pixar-style 3D character portrait of a Paraguay ultra fan:
...
- Face paint or body paint in team colors: red, white, blue

**Outfit & Accessories:**
- Authentic Paraguay home jersey (colors: red, white, and blue horizontal stripes with coat of arms)
- Team scarf wrapped around neck or held aloft
- Guarani Pride — incorporate this element
