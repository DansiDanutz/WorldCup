# Mystery Supporter Prompt — South Korea

## Character Concept
The Taekwondo Master — a 90-year-old grandmaster who performs a symbolic poomsae (form) before each match, claiming to channel ki energy to the players

## Visual Description

Create a Pixar-style 3D character portrait of a mystical, legendary South Korea supporter:
...
- Skin/face: May have weathered texture, tribal markings, or symbolic paint in team colors (red, blue, black, white)

**Outfit & Accessories:**
- Traditional or culturally significant clothing mixed with team colors
- Red Devil (official) / Tiger motif subtly integrated into design
...
- Rich colors with red, blue, black, white accent lighting
