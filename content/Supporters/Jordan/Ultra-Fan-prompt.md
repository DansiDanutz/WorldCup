# Ultra Fan Prompt — Jordan

## Character Concept
A die-hard Jordan football ultra — the most passionate, loud, and dedicated supporter in the stadium. They bleed the team colors (black, white, green, red) and live for match day.

## Visual Description

Create a Pixar-style 3D character portrait of a Jordan ultra fan:
...
- Face paint or body paint in team colors: black, white, green, red

**Outfit & Accessories:**
- Authentic Jordan home jersey (colors: black, white, and green horizontal stripes with red triangle and star)
- Team scarf wrapped around neck or held aloft
- Nashama (Brave Ones) Pride — incorporate this element
