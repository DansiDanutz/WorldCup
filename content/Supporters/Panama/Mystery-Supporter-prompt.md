# Mystery Supporter Prompt — Panama

## Character Concept
The Canal Keeper — a retired canal worker who rings a symbolic ship bell before each match, claiming the waters of the canal carry the team's fortune

## Visual Description

Create a Pixar-style 3D character portrait of a mystical, legendary Panama supporter:
...
- Skin/face: May have weathered texture, tribal markings, or symbolic paint in team colors (red, white, blue)

**Outfit & Accessories:**
- Traditional or culturally significant clothing mixed with team colors
- Harpy Eagle motif subtly integrated into design
...
- Rich colors with red, white, blue accent lighting
