# Mystery Supporter Prompt — New Zealand

## Character Concept
The Silver Fern Keeper — a Maori elder who performs a karakia (prayer) with a silver fern frond before each match, connecting the team to Aotearoa's ancestors

## Visual Description

Create a Pixar-style 3D character portrait of a mystical, legendary New Zealand supporter:
...
- Skin/face: May have weathered texture, tribal markings, or symbolic paint in team colors (black, white)

**Outfit & Accessories:**
- Traditional or culturally significant clothing mixed with team colors
- Kiwi bird motif subtly integrated into design
...
- Rich colors with black, white accent lighting
