# Ultra Fan Prompt — Croatia

## Character Concept
A die-hard Croatia football ultra — the most passionate, loud, and dedicated supporter in the stadium. They bleed the team colors (red, white, blue) and live for match day.

## Visual Description

Create a Pixar-style 3D character portrait of a Croatia ultra fan:
...
**Outfit & Accessories:**
- Authentic Croatia home jersey (colors: red, white, and blue checkerboard (sahovnica))
- Team scarf wrapped around neck or held aloft
- Torcida Split Intensity — incorporate this element
