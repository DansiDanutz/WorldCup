# Ultra Fan Prompt — Sweden

## Character Concept
A die-hard Sweden football ultra — the most passionate, loud, and dedicated supporter in the stadium. They bleed the team colors (blue, yellow) and live for match day.

## Visual Description

Create a Pixar-style 3D character portrait of a Sweden ultra fan:
...
- Face paint or body paint in team colors: blue, yellow

**Outfit & Accessories:**
- Authentic Sweden home jersey (colors: blue with yellow cross)
- Team scarf wrapped around neck or held aloft
- Blagult (Blue-Yellow) Pride — incorporate this element
