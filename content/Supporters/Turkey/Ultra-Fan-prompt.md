# Ultra Fan Prompt — Turkey

## Character Concept
A die-hard Turkey football ultra — the most passionate, loud, and dedicated supporter in the stadium. They bleed the team colors (red, white) and live for match day.

## Visual Description

Create a Pixar-style 3D character portrait of a Turkey ultra fan:
...
- Face paint or body paint in team colors: red, white

**Outfit & Accessories:**
- Authentic Turkey home jersey (colors: red with white crescent and star)
- Team scarf wrapped around neck or held aloft
- Ay-Yildizlilar (Crescent-Stars) Intensity — incorporate this element
