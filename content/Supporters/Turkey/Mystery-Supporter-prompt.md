# Mystery Supporter Prompt — Turkey

## Character Concept
The Whirling Dervish — a mystic who performs a symbolic sema (whirling dance) before each match, claiming to enter a trance that reveals the final score

## Visual Description

Create a Pixar-style 3D character portrait of a mystical, legendary Turkey supporter:
...
- Grey Wolf (Bozkurt) motif subtly integrated into design
