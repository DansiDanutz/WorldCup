# Ultra Fan Prompt — Curaçao

## Character Concept
A die-hard Curaçao football ultra — the most passionate, loud, and dedicated supporter in the stadium. They bleed the team colors (blue, yellow, white) and live for match day.

## Visual Description

Create a Pixar-style 3D character portrait of a Curaçao ultra fan:
...
**Outfit & Accessories:**
- Authentic Curaçao home jersey (colors: blue with yellow stripe and white stars)
- Team scarf wrapped around neck or held aloft
- Dutch Caribbean carnival spirit — incorporate this element
