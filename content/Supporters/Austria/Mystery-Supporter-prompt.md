# Mystery Supporter Prompt — Austria

## Character Concept
The Alpine Oracle — an elderly shepherd from Tyrol who correctly predicted Austria's 1954 World Cup semifinal run and claims to read fortunes in edelweiss petals

## Visual Description

Create a Pixar-style 3D character portrait of a mystical, legendary Austria supporter:
...
- Eagle motif subtly integrated into design
