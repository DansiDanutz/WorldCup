# Mystery Supporter Prompt — Qatar

## Character Concept
The Falcon Master — a traditional falconer who releases a white falcon (symbolizing purity) before each match, claiming the bird's flight path predicts victory

## Visual Description

Create a Pixar-style 3D character portrait of a mystical, legendary Qatar supporter:
...
- Skin/face: May have weathered texture, tribal markings, or symbolic paint in team colors (maroon, white)
...
- Rich colors with maroon, white accent lighting
