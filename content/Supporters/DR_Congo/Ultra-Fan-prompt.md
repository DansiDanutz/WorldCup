# Ultra Fan Prompt — DR Congo

## Character Concept
A die-hard DR Congo football ultra — the most passionate, loud, and dedicated supporter in the stadium. They bleed the team colors (blue, yellow, red) and live for match day.

## Visual Description

Create a Pixar-style 3D character portrait of a DR Congo ultra fan:
...
- Face paint or body paint in team colors: blue, yellow, red

**Outfit & Accessories:**
- Authentic DR Congo home jersey (colors: blue with yellow star and red diagonal stripe)
- Team scarf wrapped around neck or held aloft
- Congolese Rumba Celebrations — incorporate this element
