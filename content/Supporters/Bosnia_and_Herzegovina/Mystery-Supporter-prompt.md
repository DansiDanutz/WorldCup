# Mystery Supporter Prompt — Bosnia and Herzegovina

## Character Concept
The Bridge Keeper — a fan from Mostar who stands on the Old Bridge before every match, throwing a symbolic stone into the Neretva for good luck

## Visual Description

Create a Pixar-style 3D character portrait of a mystical, legendary Bosnia and Herzegovina supporter:
...
- Skin/face: May have weathered texture, tribal markings, or symbolic paint in team colors (blue, yellow, white)

**Outfit & Accessories:**
- Traditional or culturally significant clothing mixed with team colors
- Lily motif subtly integrated into design
...
- Rich colors with blue, yellow, white accent lighting
