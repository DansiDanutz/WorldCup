# Ultra Fan Prompt — Bosnia and Herzegovina

## Character Concept
A die-hard Bosnia and Herzegovina football ultra — the most passionate, loud, and dedicated supporter in the stadium. They bleed the team colors (blue, yellow, white) and live for match day.

## Visual Description

Create a Pixar-style 3D character portrait of a Bosnia and Herzegovina ultra fan:
...
- Face paint or body paint in team colors: blue, yellow, white

**Outfit & Accessories:**
- Authentic Bosnia and Herzegovina home jersey (colors: blue with yellow triangle and white stars)
- Team scarf wrapped around neck or held aloft
- Balkan Intensity — incorporate this element
