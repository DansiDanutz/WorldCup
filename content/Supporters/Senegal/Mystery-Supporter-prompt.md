# Mystery Supporter Prompt — Senegal

## Character Concept
The Griot Storyteller — an elderly wordsmith who recites epic poems about Senegal's football history before matches, claiming the ancestors listen

## Visual Description

Create a Pixar-style 3D character portrait of a mystical, legendary Senegal supporter:
...
- Skin/face: May have weathered texture, tribal markings, or symbolic paint in team colors (green, yellow, red)

**Outfit & Accessories:**
- Traditional or culturally significant clothing mixed with team colors
- Lion of Teranga motif subtly integrated into design
...
- Rich colors with green, yellow, red accent lighting
