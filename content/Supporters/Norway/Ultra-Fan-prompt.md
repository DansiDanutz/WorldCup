# Ultra Fan Prompt — Norway

## Character Concept
A die-hard Norway football ultra — the most passionate, loud, and dedicated supporter in the stadium. They bleed the team colors (red, blue, white) and live for match day.

## Visual Description

Create a Pixar-style 3D character portrait of a Norway ultra fan:
...
- Face paint or body paint in team colors: red, blue, white

**Outfit & Accessories:**
- Authentic Norway home jersey (colors: red with blue cross outlined in white)
- Team scarf wrapped around neck or held aloft
- Viking Spirit — incorporate this element
