# Mystery Supporter Prompt — Ghana

## Character Concept
The Golden Stool Guardian — a traditional chief who carries a miniature replica of the Ashanti Golden Stool to every match, blessing the team before kickoff

## Visual Description

Create a Pixar-style 3D character portrait of a mystical, legendary Ghana supporter:
...
- Skin/face: May have weathered texture, tribal markings, or symbolic paint in team colors (red, yellow, green, black)

**Outfit & Accessories:**
- Traditional or culturally significant clothing mixed with team colors
- Black Star motif subtly integrated into design
...
- Rich colors with red, yellow, green, black accent lighting
