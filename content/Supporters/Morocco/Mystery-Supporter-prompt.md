# Mystery Supporter Prompt — Morocco

## Character Concept
The Gnawa Mystic — a musician who plays the guembri before each match, claiming to channel the spirits of Moroccan kings who protected the nation

## Visual Description

Create a Pixar-style 3D character portrait of a mystical, legendary Morocco supporter:
...
- Skin/face: May have weathered texture, tribal markings, or symbolic paint in team colors (red, green)

**Outfit & Accessories:**
- Traditional or culturally significant clothing mixed with team colors
- Atlas Lion motif subtly integrated into design
...
- Rich colors with red, green accent lighting
