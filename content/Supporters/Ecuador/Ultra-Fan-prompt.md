# Ultra Fan Prompt — Ecuador

## Character Concept
A die-hard Ecuador football ultra — the most passionate, loud, and dedicated supporter in the stadium. They bleed the team colors (yellow, blue, red) and live for match day.

## Visual Description

Create a Pixar-style 3D character portrait of a Ecuador ultra fan:
...
- Face paint or body paint in team colors: yellow, blue, red

**Outfit & Accessories:**
- Authentic Ecuador home jersey (colors: yellow, blue, and red horizontal stripes with coat of arms)
- Team scarf wrapped around neck or held aloft
- Andean Pride — incorporate this element
