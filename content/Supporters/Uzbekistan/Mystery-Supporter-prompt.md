# Mystery Supporter Prompt — Uzbekistan

## Character Concept
The Silk Road Sage — an elderly craftsman from Bukhara who weaves a small carpet before each match depicting the game, claiming the patterns reveal destiny

## Visual Description

Create a Pixar-style 3D character portrait of a mystical, legendary Uzbekistan supporter:
...
- Skin/face: May have weathered texture, tribal markings, or symbolic paint in team colors (blue, white, green)

**Outfit & Accessories:**
- Traditional or culturally significant clothing mixed with team colors
- White Wolf (Ak Bo'ri) motif subtly integrated into design
...
- Rich colors with blue, white, green accent lighting
