# Ultra Fan Prompt — Scotland

## Character Concept
A die-hard Scotland football ultra — the most passionate, loud, and dedicated supporter in the stadium. They bleed the team colors (navy blue, white) and live for match day.

## Visual Description

Create a Pixar-style 3D character portrait of a Scotland ultra fan:
...
- Face paint or body paint in team colors: navy blue, white

**Outfit & Accessories:**
- Authentic Scotland home jersey (colors: white saltire (St. Andrew's Cross) on blue field)
- Team scarf wrapped around neck or held aloft
- Tartan Army Legendary Fan Culture — incorporate this element
