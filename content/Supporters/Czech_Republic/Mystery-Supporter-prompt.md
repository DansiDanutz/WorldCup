# Mystery Supporter Prompt — Czech Republic

## Character Concept
The Astronomer — a Prague local who claims to calculate match outcomes using Kepler's laws at the Old Town Square astronomical clock before each game

## Visual Description

Create a Pixar-style 3D character portrait of a mystical, legendary Czech Republic supporter:
...
- Skin/face: May have weathered texture, tribal markings, or symbolic paint in team colors (white, red, blue)

**Outfit & Accessories:**
- Traditional or culturally significant clothing mixed with team colors
- Lion motif subtly integrated into design
...
- Rich colors with white, red, blue accent lighting
