# Mystery Supporter Prompt — Colombia

## Character Concept
The Coffee Shaman — a farmer from the Zona Cafetera who sprinkles ground coffee in a circle before each match, claiming it connects the team to Colombian soil

## Visual Description

Create a Pixar-style 3D character portrait of a mystical, legendary Colombia supporter:
...
- Skin/face: May have weathered texture, tribal markings, or symbolic paint in team colors (yellow, blue, red)

**Outfit & Accessories:**
- Traditional or culturally significant clothing mixed with team colors
- Andean Condor motif subtly integrated into design
...
- Rich colors with yellow, blue, red accent lighting
