# Ultra Fan Prompt — Colombia

## Character Concept
A die-hard Colombia football ultra — the most passionate, loud, and dedicated supporter in the stadium. They bleed the team colors (yellow, blue, red) and live for match day.

## Visual Description

Create a Pixar-style 3D character portrait of a Colombia ultra fan:
...
**Outfit & Accessories:**
- Authentic Colombia home jersey (colors: yellow, blue, and red horizontal stripes)
- Team scarf wrapped around neck or held aloft
- Cumbia Dancing — incorporate this element
