# Ultra Fan Prompt — Ivory Coast

## Character Concept
A die-hard Ivory Coast football ultra — the most passionate, loud, and dedicated supporter in the stadium. They bleed the team colors (orange, white, green) and live for match day.

## Visual Description

Create a Pixar-style 3D character portrait of a Ivory Coast ultra fan:
...
- Face paint or body paint in team colors: orange, white, green

**Outfit & Accessories:**
- Authentic Ivory Coast home jersey (colors: orange, white, and green vertical stripes)
- Team scarf wrapped around neck or held aloft
- Les Elephants Fever — incorporate this element
