# Mystery Supporter Prompt — Ivory Coast

## Character Concept
The Elephant Whisperer — a traditional leader who carries a carved ivory tusk fragment (ethically sourced) to matches, said to channel elephant strength

## Visual Description

Create a Pixar-style 3D character portrait of a mystical, legendary Ivory Coast supporter:
...
- Skin/face: May have weathered texture, tribal markings, or symbolic paint in team colors (orange, white, green)

**Outfit & Accessories:**
- Traditional or culturally significant clothing mixed with team colors
- Elephant motif subtly integrated into design
...
- Rich colors with orange, white, green accent lighting
