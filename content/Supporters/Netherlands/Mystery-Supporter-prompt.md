# Mystery Supporter Prompt — Netherlands

## Character Concept
The Tulip Oracle — an elderly horticulturist from Keukenhof who claims the orientation of his specially-bred orange tulips predicts match outcomes

## Visual Description

Create a Pixar-style 3D character portrait of a mystical, legendary Netherlands supporter:
...
- Skin/face: May have weathered texture, tribal markings, or symbolic paint in team colors (orange, white, blue)

**Outfit & Accessories:**
- Traditional or culturally significant clothing mixed with team colors
- Orange Lion motif subtly integrated into design
...
- Rich colors with orange, white, blue accent lighting
