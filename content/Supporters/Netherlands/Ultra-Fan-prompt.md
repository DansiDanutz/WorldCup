# Ultra Fan Prompt — Netherlands

## Character Concept
A die-hard Netherlands football ultra — the most passionate, loud, and dedicated supporter in the stadium. They bleed the team colors (orange, white, blue) and live for match day.

## Visual Description

Create a Pixar-style 3D character portrait of a Netherlands ultra fan:
...
- Face paint or body paint in team colors: orange, white, blue

**Outfit & Accessories:**
- Authentic Netherlands home jersey (colors: red, white, and blue horizontal stripes (flag of the Netherlands))
- Team scarf wrapped around neck or held aloft
- Oranje Madness — incorporate this element
