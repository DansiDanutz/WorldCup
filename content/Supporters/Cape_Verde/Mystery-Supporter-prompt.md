# Mystery Supporter Prompt — Cape Verde

## Character Concept
The Morna Singer — an elderly woman who sings traditional morna songs before every match, said to channel Cesaria Evora's spirit for luck

## Visual Description

Create a Pixar-style 3D character portrait of a mystical, legendary Cape Verde supporter:
...
- Skin/face: May have weathered texture, tribal markings, or symbolic paint in team colors (blue, white, red, yellow)

**Outfit & Accessories:**
- Traditional or culturally significant clothing mixed with team colors
- Sea turtle motif subtly integrated into design
...
- Rich colors with blue, white, red, yellow accent lighting
