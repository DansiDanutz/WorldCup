# Ultra Fan Prompt — Cape Verde

## Character Concept
A die-hard Cape Verde football ultra — the most passionate, loud, and dedicated supporter in the stadium. They bleed the team colors (blue, white, red, yellow) and live for match day.

## Visual Description

Create a Pixar-style 3D character portrait of a Cape Verde ultra fan:
...
- Face paint or body paint in team colors: blue, white, red, yellow

**Outfit & Accessories:**
- Authentic Cape Verde home jersey (colors: blue with white, red, and yellow stripes and stars)
- Team scarf wrapped around neck or held aloft
- Small Island Nation Pride — incorporate this element
