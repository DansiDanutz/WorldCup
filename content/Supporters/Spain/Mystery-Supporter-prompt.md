# Mystery Supporter Prompt — Spain

## Character Concept
The Flamenco Oracle — a mysterious dancer who performs a solea (flamenco form) before each match, claiming the rhythm reveals the game's soul

## Visual Description

Create a Pixar-style 3D character portrait of a mystical, legendary Spain supporter:
...
- Skin/face: May have weathered texture, tribal markings, or symbolic paint in team colors (red, yellow)

**Outfit & Accessories:**
- Traditional or culturally significant clothing mixed with team colors
- Bull ( Osborne bull style) motif subtly integrated into design
...
- Rich colors with red, yellow accent lighting
