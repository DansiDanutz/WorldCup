# Mystery Supporter Prompt — Iraq

## Character Concept
The Babylonian Scribe — a historian who writes match predictions in cuneiform-style script on clay tablets, claiming to channel ancient Mesopotamian wisdom

## Visual Description

Create a Pixar-style 3D character portrait of a mystical, legendary Iraq supporter:
...
- Skin/face: May have weathered texture, tribal markings, or symbolic paint in team colors (red, white, black, green)

**Outfit & Accessories:**
- Traditional or culturally significant clothing mixed with team colors
- Lion of Babylon motif subtly integrated into design
...
- Rich colors with red, white, black, green accent lighting
