# Ultra Fan Prompt — Iraq

## Character Concept
A die-hard Iraq football ultra — the most passionate, loud, and dedicated supporter in the stadium. They bleed the team colors (red, white, black, green) and live for match day.

## Visual Description

Create a Pixar-style 3D character portrait of a Iraq ultra fan:
...
- Face paint or body paint in team colors: red, white, black, green

**Outfit & Accessories:**
- Authentic Iraq home jersey (colors: red, white, and black horizontal stripes with green text and stars)
- Team scarf wrapped around neck or held aloft
- Lions Of Mesopotamia Pride — incorporate this element
