# Ultra Fan Prompt — Haiti

## Character Concept
A die-hard Haiti football ultra — the most passionate, loud, and dedicated supporter in the stadium. They bleed the team colors (blue, red) and live for match day.

## Visual Description

Create a Pixar-style 3D character portrait of a Haiti ultra fan:
...
- Face paint or body paint in team colors: blue, red

**Outfit & Accessories:**
- Authentic Haiti home jersey (colors: blue and red horizontal stripes with coat of arms)
- Team scarf wrapped around neck or held aloft
- Caribbean Resilience — incorporate this element
