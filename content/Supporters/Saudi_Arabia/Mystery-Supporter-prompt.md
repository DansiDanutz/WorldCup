# Mystery Supporter Prompt — Saudi Arabia

## Character Concept
The Sword Prophet — a historian who claims to interpret match outcomes from the patterns of traditional Saudi sword dances (ardah) performed before kickoff

## Visual Description

Create a Pixar-style 3D character portrait of a mystical, legendary Saudi Arabia supporter:
...
- Skin/face: May have weathered texture, tribal markings, or symbolic paint in team colors (green, white)

**Outfit & Accessories:**
- Traditional or culturally significant clothing mixed with team colors
- Falcon motif subtly integrated into design
...
- Rich colors with green, white accent lighting
