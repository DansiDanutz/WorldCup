...
"[project]/src/app/api/referrals/resolve/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    const limited = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["enforceRateLimit"])(request, "referral-resolve", {
        limit: 30,
        windowMs: 60_000
    });
    if (limited) {
    ...
    const referralCode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$referrals$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeReferralCode"])(url.searchParams.get("code"));
    if (!referralCode) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            valid: false
        });
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createServiceSupabaseClient"])();
    const profile = await supabase.from("worldcup_referral_profiles").select("user_id,referral_code,display_name").eq("referral_code", referralCode).maybeSingle();
    if (profile.error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            valid: false
        }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0v7jwmm._.js.map